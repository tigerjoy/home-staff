-- Create RPC function for transactional employee + employment + related data creation.
-- All inserts run in a single transaction; any failure rolls back everything.
...
BEGIN
  ...
  VALUES (
    v_employee_id,
    (p_employment->>'household_id')::UUID,
    v_employment_type,
    p_employment->>'role',
